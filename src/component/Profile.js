...
class Menu extends Component {
        ...
        <div className='profileDiv '>
          ...
          <div className='ImgDiv  '>
            ...
            <div className='seller_BuyerDiv '>
              ...
              <div className='nationality p_font G_flex G_WCol'>
  ...
  {/* Visible when viewing  others profile          */}
              {user ?<div className='messageDiv G_smallestFont'>
                <NavLink  exact={true} to="/SignIn" activeClassName="is-active" className='G_Btn G_lgtBck G_BCol'> Message </NavLink>
              </div> : undefined}
            </div> 
          </div>

          <div className='profile_Name  G_smallerFont'>
            <a href='#' className='G_WCol'>Kings Nduka</a>
            <p className='profile_UserName p_font G_WCol'>KingsNduka</p>
          </div>
  ...
  {/* Location visible to only  other viewers */}
          <div className='footer'>
            {user ?<div className='location p_font G_flex G_middle G_WCol'>
