          ...
          <form className='formSize M_formSize'>
            <div class="SignUpForm_container">
              ...
              <label className=' G_smallerFont G_centerTx  G_SmallerFontStyle M_smallerFont G_textLineHeight' >
                <input type="checkbox" checked="checked" name="remember" className='checkBox G_smallerFont '></input> By creating an account, you agree to our
              ...
              <div class="btnDiv G_flex G_middle">
                ...
                <button type="submit" className='G_smallBtn G_Btn M_smallBtn'>SignUp</button>
              </div>
